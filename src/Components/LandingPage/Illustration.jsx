                ...
                <div className='flex'>
                    <div>
                        <div className='outline outline-[3px] outline-white rounded-full relative w-[3rem] h-[3rem]'>
                            <img alt="ERROR" src='https://res.cloudinary.com/de2rges3m/image/upload/v1693402839/Chat%20App/Login%20page/cheerful-indian-businessman-smiling-closeup-portrait-jobs-career-campaign_53876-129417_sgu0rq.avif' className='w-[3rem] h-[3rem] object-cover rounded-full'/>
...
{/* Second Block */}
        <div className='relative flex items-center justify-center -mt-[5rem] translate-x-16 ml-auto '>
            ...
            <img alt="Error" src='https://res.cloudinary.com/de2rges3m/image/upload/v1693388089/Chat%20App/Login_Image_avrppq.png' className='w-[30rem] h-[30rem] object-cover z-10 -translate-y-14 ' />
        </div>
            ...
            <div className='w-[14rem] bg-[#f3f3f3] -ml-8 mr-24 rounded-[20px] flex flex-col p-6 space-y-3 mt-[6.5rem]'>
                ...
                <div className='w-full h-12 bg-[#4b8cf5] rounded-xl flex justify-between px-[1.4rem] items-center'>
                    <div className='outline rounded-full outline-white'>
                        <img alt="Error" src='https://res.cloudinary.com/de2rges3m/image/upload/v1693395561/Chat%20App/Login%20page/360_F_299042079_vGBD7wIlSeNl7vOevWHiL93G4koMM967_jmbcjj.jpg' className='w-[2.2rem] h-[2.2rem] object-cover rounded-full' />
                    </div>
                    <div className='outline rounded-full outline-white'>
                        <img alt="Error" src='https://res.cloudinary.com/de2rges3m/image/upload/v1693395561/Chat%20App/Login%20page/360_F_383258331_D8imaEMl8Q3lf7EKU2Pi78Cn0R7KkW9o_duczsv.jpg' className='w-[2.2rem] h-[2.2rem] object-cover rounded-full' />
                    </div>
                    <div className='outline rounded-full outline-white'>
                        <img alt="Error" src='https://res.cloudinary.com/de2rges3m/image/upload/v1693395562/Chat%20App/Login%20page/getty_481292845_77896_h4gvea.jpg' className='w-[2.2rem] h-[2.2rem] object-cover rounded-full ' />
                    </div>
                </div>
                ...
                <div className='w-full h-12 bg-neutral-200 rounded-xl flex px-2.5 items-center text-neutral-400'>
                    ...
                    <PiNumberCircleThreeLight size={23} className='text-[#f68230] ml-auto'/>
                </div>  
            </div>
